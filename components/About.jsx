      ...
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
          ...
          <p className='py-2 text-gray-600'>
            I am an entry-level Front-End Enginner who always has a knack for
            technology and working with computers. In 2021 I started working
            with HTML and CSS to make some minor edits on small business
            websites. What I thought was just a few small
